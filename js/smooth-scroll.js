...
var smoothScroll = (function(){
    ...
    function moveElements(position){
        elementsToMove.forEach(function(element){
            moveElement(position, element.initialPosition, element.speed, element.direction, element.dom);
        });
    }

    function moveElement(position, initialPosition, speed, direction, element){
        var percentage = (position/ document.body.clientHeight * 100 * speed) * direction;
        // element.style.top = initialPosition + percentage + '%';
        // element.style.marginTop = initialPosition - percentage + '%';
